...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
      try {
        int idProduto = Integer.parseInt(id_produto_venda.getText()); // Obtém o ID do produto a ser vendido
        ProdutosDAO produtosdao = new ProdutosDAO();
        
        // Chama o método de vender produto no DAO
        ...
        JOptionPane.showMessageDialog(this, "Por favor, insira um ID de produto válido.");
    } catch (Exception e) {
        e.printStackTrace();
   ...
   public void listarProdutos() {
    try {
        ...
        model.setNumRows(0);  // Limpa a tabela antes de adicionar novas linhas
        ...
        e.printStackTrace(); // Adiciona este código para depuração
    }
}
